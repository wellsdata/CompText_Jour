...
You will be trained on best practices to extract specific material from digitized historical records
You will recognize and interpret metadata (such as headline, date, publication) and use to conduct analysis of journalistic content.
...
By the end of the semester, we want you to have basic proficiency and independence with data analysis. We want you to be able to write about data clearly, using the Associated Press style as a benchmark. We want you to be able to find and download a dataset, clean it up, visualize it.

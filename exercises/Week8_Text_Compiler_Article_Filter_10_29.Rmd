...
jackindex_oct19 <- read_csv("../data/articles_oct_19.csv")
...
### Sean Mussenden's raw text compiler 
```{r include=FALSE}
...
write.csv(articles_df, "../exercises/assets/extracted_text/kemi_df.csv")

```



# Edit below, may not be necessary

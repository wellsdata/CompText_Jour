...
--We're taking the chat response and putting it into a dataframe
...
# A better AI prompt
--Spoiler alert. 
--This prompt seeks to improve on the Democrat_critique : " If an article contains two or more mentions of Democrats or the Democratic Party and if adjectives modifying Democrats are critical, classify it as 'democrat_critique'"

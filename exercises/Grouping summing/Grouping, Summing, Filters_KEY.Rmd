...
baltcity_race %>% 
  ...
  summarize(
    ...
    pac_island_total = sum(x2020_pac_islander, na.rm = TRUE)
  )
...
```{r}
mean <- round(mean(baltcity_income$x2020, na.rm= TRUE),0)
```
...
```{r}
print(paste0("The percentage of the city's census tracts below the average of $", mean, " is: ", answer2,"%"))
```
